...
def count_tensor_elements(x):
  ...
  for dim_idx in range(num_dimensions):
    num_elements = num_elements * x.shape[dim_idx]
  #############################################################################
  #                    TODO: Implement this function                          #
...
def multiples_of_ten(start, stop):
  ...
  """
  assert start <= stop
  first_valid = start + 10 - start%10

  if first_valid > stop:
    x = torch.tensor([], dtype=torch.float64)

  else:
    x = torch.arange(start=first_valid, end=stop+1, step=10, dtype=torch.float64)
...
def reverse_rows(x):
  ...
  """
  idx2 = list(range(x.shape[0]-1, -1, -1))
  y = x[idx2, :]
  #############################################################################
  #                    TODO: Implement this function                          #
  #############################################################################
